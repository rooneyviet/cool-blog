...
const user_upsert_without_comments_input_1 = require("./user-upsert-without-comments.input");
const client_1 = require("@prisma/client");
const user_where_unique_input_1 = require("./user-where-unique.input");
const user_update_to_one_with_where_without_comments_input_1 = require("./user-update-to-one-with-where-without-comments.input");
...
__decorate([
    (0, graphql_1.Field)(() => user_upsert_without_comments_input_1.UserUpsertWithoutCommentsInput, { nullable: true }),
    (0, class_transformer_1.Type)(() => user_upsert_without_comments_input_1.UserUpsertWithoutCommentsInput),
    __metadata("design:type", user_upsert_without_comments_input_1.UserUpsertWithoutCommentsInput)
...
__decorate([
    (0, graphql_1.Field)(() => user_update_to_one_with_where_without_comments_input_1.UserUpdateToOneWithWhereWithoutCommentsInput, { nullable: true }),
    (0, class_transformer_1.Type)(() => user_update_to_one_with_where_without_comments_input_1.UserUpdateToOneWithWhereWithoutCommentsInput),
    __metadata("design:type", user_update_to_one_with_where_without_comments_input_1.UserUpdateToOneWithWhereWithoutCommentsInput)
], UserUpdateOneRequiredWithoutCommentsNestedInput.prototype, "update", void 0);
exports.UserUpdateOneRequiredWithoutCommentsNestedInput = UserUpdateOneRequiredWithoutCommentsNestedInput = __decorate([
    (0, graphql_2.InputType)()
], UserUpdateOneRequiredWithoutCommentsNestedInput);
//# sourceMappingURL=user-update-one-required-without-comments-nested.input.js.map